...
class GPT(nn.Module):
    ...
    # FIX: Added `master_process` as a parameter to avoid scope issues
...
class DataLoaderLite:
    ...
    def __init__(self, B, T, process_rank, num_processes, split, master_process=True):
        ...
        root_path = "/inspire/hdd/tenant_predefaa-9a1b-4522-bb10-8850f313be13/global_public/"
        data_root = root_path + "datasets-models/lecture-06-gpts-edu_fineweb10B"
